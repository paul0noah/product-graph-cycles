...
setup(
    name='Cyclic Product Graph Generator',
    version='0.0.1',
    description='Product Graphs based upon 2D-3D Dijkstra formalism',
    packages=find_packages(),
    ext_modules=[CMakeExtension(name='cyclic_product_graphs')],
